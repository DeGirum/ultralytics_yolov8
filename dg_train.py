...
def parser_arguments():
    ...
    parser.add_argument('--close-mosaic', type=int, default=5, help='(int) disable mosaic augmentation for final epochs')
    ...
    parser.add_argument('--fliplr', type=float, default=0.5, help='image scale (+/- gain)')
